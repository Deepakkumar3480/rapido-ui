...
const Slider1 = ({feedback}) => {
  ...
  return (
    <div className={`slider-container`}>
        ...
        {feedback && feedback.map((feed,index)=>(
          ...
          <div className="row w-100 mx-auto">
            ...
            <div className="col-md-9 pt-md-4">     
                <p className='slider-text text-dark'>{feed.body}</p>
      ...
      <FaLessThan className={`prev-button ${darkmode ? 'bg-secondary' : ''}`} onClick={previous}/>
      <FaGreaterThan className={`next-button ${darkmode ? 'bg-secondary' : ''}`} onClick={next}/>
    </div>
  )
}
