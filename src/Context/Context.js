  ...
  setElementError(inputError)
     ...
     return(
        <DataContext.Provider value={{
          darkmode,setdarkmode,active,setActive,toggleActive,setToggleActive,toggleActive1,setToggleActive1,safetyNav,setSafetyNav,handleChange,handleSubmit,formData,elementError
        }}>
            {children}
